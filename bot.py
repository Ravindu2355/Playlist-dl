...
async def set_cookie(client, message: Message):
    ...
    # Prepare the Netscape-format cookies
    cookie_lines = [
        "# Netscape HTTP Cookie File\n"
        "# This file was generated by pyrogram bot\n"
    ...
    for cookie in cookies:
        try:
            ...
            # Generate a valid Netscape format cookie line
            # Netscape format: domain, true/false for secure, path, expiry (0 for session cookie), key, value
            cookie_line = f".youtube.com\tTRUE\t/\tFALSE\t0\t{key}\t{value}"
            cookie_lines.append(cookie_line)
        except ValueError:
            continue  # Skip any malformed cookies

    # Save the cookies in the Netscape format
    cookie_file = "cookies.txt"
    with open(cookie_file, "w") as f:
        f.writelines("\n".join(cookie_lines) + "\n")
        
    await message.reply_text("✅ Cookies have been saved in Netscape format!")
